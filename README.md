...
**공공 대국민 AI 챗봇 운영팀** · 2026 ~ 현재
　└ **시나리오 챗봇 → RAG 전환 과제** · 발주 기관 제안용

기존 시나리오 기반 챗봇을 RAG로 전환하는 과제에서 백엔드 파이프라인을 맡고 있습니다.
5인 규모로 시작했으나 구성원이 타 사업·휴직으로 빠지는 동안 설계부터 배포·평가체계까지 이어 맡았고,
현재 2인으로 마무리 단계입니다.

행정·교통·연금·통관 등 도메인별 지식베이스를 하나의 라우팅 계층 아래 묶어,
